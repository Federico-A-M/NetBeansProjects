 ...
 * usuario todos sus datos y guardándolos en el objeto Pelicula. Después, esa
 * Pelicula se guarda una lista de Peliculas y se le pregunta al usuario si
...
public class MainCine {
    ...
    public static void main(String[] args) {
        ...
        ServicioCine pelis = new ServicioCine();
        pelis.llenarPelis();
        pelis.opciones();
