 ...
 * a elección de esta página: https://mapanet.eu/index.htm.
 * 
 * Nota: Poner el código postal sin la letra, solo el numero.
 *  
 * • Pedirle al usuario que ingrese 10 códigos
 * postales y sus ciudades. 
 * 
 ...
 * 
 * • Agregar una ciudad con su código
 * postal correspondiente más al HashMap.
 * 
 * • Elimina 3 ciudades existentes dentro
 * del HashMap, que pida el usuario. 
 * 
 * • Muestra por pantalla los dato
 * 
 */
public class extr4 {
