...
public class ValoresMain {
    ...
    public static void mostrarSumayPromedio(ArrayList<Integer> n) {
        ...
        System.out.println("La suma de todos los numeros fue: " + aux);
        System.out.println("El promedio la lista es: " + aux/n.size());
