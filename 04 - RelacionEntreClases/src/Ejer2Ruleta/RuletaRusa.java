...
public class RuletaRusa {
    ...
    public static void main(String[] args) {
        ...
        Jugador player1 = new Jugador("Federico", false);
        Jugador player2 = new Jugador("Cristian", false);
        Jugador player3 = new Jugador("Tamara", false);
        Jugador player4 = new Jugador("Matias", false);
        Jugador player5 = new Jugador("Victoria", false);
        Jugador player6 = new Jugador("Jose", false);
        
        jugadores.add(player1);
        jugadores.add(player2);
        jugadores.add(player3);
        jugadores.add(player4);
        jugadores.add(player5);
        jugadores.add(player6);
        
        
        
        game.setJuego(jugadores);
        game.setPistolita(pistol);
        game.llenarJuego(jugadores, pistol);
        game.ronda(game.inicia(), jugadores, pistol);
