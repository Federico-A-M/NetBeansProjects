...
public class AdopcionMain {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Mascotas> perritos = new ArrayList();
        ArrayList<Mascotas> gatitos = new ArrayList();
        
        
        
        Persona Fed = new Persona("Federico", "Martin", 30, 35632588, perritos); 
        Persona Marien = new Persona("Marien", "Gutierres", 28, 35687588, gatitos); 
        
        Mascotas Negra = new Mascotas("Negrita", "perrito", 10, 20.5);
        Mascotas Blondie = new Mascotas("Blondie", "perrito", 5, 25.5);
        
        Mascotas Chia = new Mascotas("Chia", "Gatito", 7, 12.5);
        Mascotas Bruna = new Mascotas("Bruna", "Gatito", 8, 10.5);

        perritos.add(Negra);
        perritos.add(Blondie);
 
        gatitos.add(Chia);
        gatitos.add(Bruna);
        
        System.out.println(Fed);
        System.out.println(Marien);
