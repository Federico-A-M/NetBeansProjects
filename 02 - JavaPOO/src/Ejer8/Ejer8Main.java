...
public class Ejer8Main {
    ...
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in).useDelimiter("\n");
            ...
            serv.crearFrase(palabras);
            System.out.println(palabras.toString());
            
            serv.contarVocales(palabras);
            serv.invertirFrase(palabras);
            serv.vecesRepetido(palabras);
            
            System.out.println(" ");
            System.out.println("Genere una nueva frase para comparar con la primera: ");
            Cadena palabras2 = new Cadena();
            serv.crearFrase(palabras2);
            serv.compararLongitud(palabras, palabras2);
            
            serv.unirFrases(palabras, palabras2);
            
            //serv.reemplazar(palabras); no funciono el mio, habia opcion mas facil.
            serv.reemplazar2(palabras);
            
            serv.contiene(palabras);
