...
public class ArrayIndexOutOfBoundsExcep {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Integer> cosito = new ArrayList();
        ...
        Algunaclase coso = new Algunaclase(cosito);


        
        try {

            for (int i = 0; i < coso.getNumeros().size() + 4; i++) {
                
                System.out.println(coso.getNumeros().get(i));
            }

        } catch (ArrayIndexOutOfBoundsException e) {

            System.err.println("La busqueda excede la cantidad de posiciones del arreglo");
            
        } catch (IndexOutOfBoundsException f) {
            
            System.err.println("Error de sistema, tipos de datos no validos");
