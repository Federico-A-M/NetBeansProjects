...
public class MainAnimal {
    ...
    public static void main(String[] args) {
        ...
        Animal perro = new Perro("Guau", "Blondie", " todo", 7, "callejera");
         perro.comer();
        Perro perro2 = new Perro("Guauuu", "Negra", " todo", 20, "callejerita");
         perro2.comer();

        Animal michini = new Gato("miauu", true, "Bruna", " whiskas", 4, "vaquita");
         michini.comer();

         Animal potro = new Caballo("Pfffsrrsr", "Rodrigo", " Alfalfa", 11, "Negro");
         potro.comer();
